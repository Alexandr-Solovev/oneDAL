/* file: pca_covariance_dense_distributed_mpi.cpp */
/*******************************************************************************
...
/*
!  Content:
!    C++ sample of principal component analysis (PCA) using
!    the variance-covariance matrix computed with covariance algorithm
...
int main(int argc, char * argv[])
{
    ...
    /* Compute partial variance-covariance matrices on nodes */
    ...
    if (rankId == mpi_root)
    {
        ...
        /* Merge and finalizeCompute variance-covariance matrix on the master node */
