...
CALL_VOID_FUNC_FROM_DLL(mkl_blas_, dsyrk,
...
CALL_VOID_FUNC_FROM_DLL(mkl_blas_, ssyrk,
...
CALL_VOID_FUNC_FROM_DLL(mkl_blas_, sgemm,
...
CALL_VOID_FUNC_FROM_DLL(mkl_blas_, xdgemm,
                        (const char * transa, const char * transb, const DAAL_INT * m, const DAAL_INT * n, const DAAL_INT * k, const double * alpha,
                         const double * a, const DAAL_INT * lda, const double * b, const DAAL_INT * ldb, const double * beta, double * c,
                         const DAAL_INT * ldc),
                        (transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc));
CALL_VOID_FUNC_FROM_DLL(mkl_blas_, xsgemm,
                        (const char * transa, const char * transb, const DAAL_INT * m, const DAAL_INT * n, const DAAL_INT * k, const float * alpha,
                         const float * a, const DAAL_INT * lda, const float * b, const DAAL_INT * ldb, const float * beta, float * c,
                         const DAAL_INT * ldc),
                        (transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc));

CALL_VOID_FUNC_FROM_DLL(mkl_blas_, dsymm,
...
CALL_VOID_FUNC_FROM_DLL(mkl_blas_, ssymm,
...
CALL_VOID_FUNC_FROM_DLL(mkl_blas_, dgemv,
...
CALL_VOID_FUNC_FROM_DLL(mkl_blas_, sgemv,
...
CALL_VOID_FUNC_FROM_DLL(mkl_blas_, daxpy,
                        (const DAAL_INT * n, const double * alpha, const double * x, const DAAL_INT * incx, double * y, const DAAL_INT * incy),
                        (n, alpha, x, incx, y, incy));
CALL_VOID_FUNC_FROM_DLL(mkl_blas_, saxpy,
                        (const DAAL_INT * n, const float * alpha, const float * x, const DAAL_INT * incx, float * y, const DAAL_INT * incy),
                        (n, alpha, x, incx, y, incy));

CALL_VOID_FUNC_FROM_DLL(mkl_blas_, xdsyr,
                        (const char * uplo, const DAAL_INT * n, const double * alpha, const double * x, const DAAL_INT * incx, double * a,
                         const DAAL_INT * lda),
                        (uplo, n, alpha, x, incx, a, lda));
CALL_VOID_FUNC_FROM_DLL(mkl_blas_, xssyr,
                        (const char * uplo, const DAAL_INT * n, const float * alpha, const float * x, const DAAL_INT * incx, float * a,
                         const DAAL_INT * lda),
                        (uplo, n, alpha, x, incx, a, lda));

CALL_VOID_FUNC_FROM_DLL(mkl_blas_, xdsyrk,
                        (const char * uplo, const char * trans, const DAAL_INT * n, const DAAL_INT * k, const double * alpha, const double * a,
                         const DAAL_INT * lda, const double * beta, double * c, const DAAL_INT * ldc),
                        (uplo, trans, n, k, alpha, a, lda, beta, c, ldc));
CALL_VOID_FUNC_FROM_DLL(mkl_blas_, xssyrk,
                        (const char * uplo, const char * trans, const DAAL_INT * n, const DAAL_INT * k, const float * alpha, const float * a,
                         const DAAL_INT * lda, const float * beta, float * c, const DAAL_INT * ldc),
                        (uplo, trans, n, k, alpha, a, lda, beta, c, ldc));

CALL_VOID_FUNC_FROM_DLL(mkl_blas_, xdsymm,
                        (const char * side, const char * uplo, const DAAL_INT * m, const DAAL_INT * n, const double * alpha, const double * a,
                         const DAAL_INT * lda, const double * b, const DAAL_INT * ldb, const double * beta, double * c, const DAAL_INT * ldc),
                        (side, uplo, m, n, alpha, a, lda, b, ldb, beta, c, ldc));
CALL_VOID_FUNC_FROM_DLL(mkl_blas_, xssymm,
                        (const char * side, const char * uplo, const DAAL_INT * m, const DAAL_INT * n, const float * alpha, const float * a,
                         const DAAL_INT * lda, const float * b, const DAAL_INT * ldb, const float * beta, float * c, const DAAL_INT * ldc),
                        (side, uplo, m, n, alpha, a, lda, b, ldb, beta, c, ldc));

CALL_VOID_FUNC_FROM_DLL(mkl_spblas_, mkl_dcsrmultd,
...
CALL_VOID_FUNC_FROM_DLL(mkl_spblas_, mkl_scsrmultd,
...
CALL_VOID_FUNC_FROM_DLL(mkl_spblas_, mkl_dcsrmv,
...
CALL_VOID_FUNC_FROM_DLL(mkl_spblas_, mkl_scsrmv,
...
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, dpotrf, (const char * uplo, const DAAL_INT * n, double * a, const DAAL_INT * lda, DAAL_INT * info, int iuplo),
                        (uplo, n, a, lda, info, iuplo));
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, spotrf, (const char * uplo, const DAAL_INT * n, float * a, const DAAL_INT * lda, DAAL_INT * info, int iuplo),
                        (uplo, n, a, lda, info, iuplo));

CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, dpotrs,
...
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, sgetrs,
...
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, dpotri, (const char * uplo, const DAAL_INT * n, double * a, const DAAL_INT * lda, DAAL_INT * info, int iuplo),
                        (uplo, n, a, lda, info, iuplo));
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, spotri, (const char * uplo, const DAAL_INT * n, float * a, const DAAL_INT * lda, DAAL_INT * info, int iuplo),
                        (uplo, n, a, lda, info, iuplo));

CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, dgerqf,
...
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, sormrq,
...
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, dormqr,
                        (const char * side, const char * trans, const DAAL_INT * m, const DAAL_INT * n, const DAAL_INT * k, const double * a,
                         const DAAL_INT * lda, const double * tau, double * c, const DAAL_INT * ldc, double * work, const DAAL_INT * lwork,
                         DAAL_INT * info, int iside, int itrans),
                        (side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork, info, iside, itrans));
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, sormqr,
                        (const char * side, const char * trans, const DAAL_INT * m, const DAAL_INT * n, const DAAL_INT * k, const float * a,
                         const DAAL_INT * lda, const float * tau, float * c, const DAAL_INT * ldc, float * work, const DAAL_INT * lwork,
                         DAAL_INT * info, int iside, int itrans),
                        (side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork, info, iside, itrans));

CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, dtrtrs,
...
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, strtrs,
...
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, dpptrf, (const char * uplo, const DAAL_INT * n, double * ap, DAAL_INT * info, int iuplo),
                        (uplo, n, ap, info, iuplo));
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, spptrf, (const char * uplo, const DAAL_INT * n, float * ap, DAAL_INT * info, int iuplo),
                        (uplo, n, ap, info, iuplo));

CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, dgeqrf,
                        (const DAAL_INT * m, const DAAL_INT * n, double * a, const DAAL_INT * lda, double * tau, double * work,
                         const DAAL_INT * lwork, DAAL_INT * info),
                        (m, n, a, lda, tau, work, lwork, info));
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, sgeqrf,
                        (const DAAL_INT * m, const DAAL_INT * n, float * a, const DAAL_INT * lda, float * tau, float * work, const DAAL_INT * lwork,
                         DAAL_INT * info),
                        (m, n, a, lda, tau, work, lwork, info));

CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, dgeqp3,
...
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, sgesvd,
...
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, dsyevd,
...
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, ssyevd,
                        (const char * jobz, const char * uplo, const DAAL_INT * n, float * a, const DAAL_INT * lda, float * w, float * work,
                         const DAAL_INT * lwork, DAAL_INT * iwork, const DAAL_INT * liwork, DAAL_INT * info, int ijobz, int iuplo),
                        (jobz, uplo, n, a, lda, w, work, lwork, iwork, liwork, info, ijobz, iuplo));

CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, dsyev,
                        (const char * jobz, const char * uplo, const DAAL_INT * n, double * a, const DAAL_INT * lda, double * w, double * work,
                         const DAAL_INT * lwork, DAAL_INT * info, int ijobz, int iuplo),
                        (jobz, uplo, n, a, lda, w, work, lwork, info, ijobz, iuplo));
CALL_VOID_FUNC_FROM_DLL(mkl_lapack_, ssyev,
                        (const char * jobz, const char * uplo, const DAAL_INT * n, float * a, const DAAL_INT * lda, float * w, float * work,
                         const DAAL_INT * lwork, DAAL_INT * info, int ijobz, int iuplo),
                        (jobz, uplo, n, a, lda, w, work, lwork, info, ijobz, iuplo));

CALL_RET_FUNC_FROM_DLL(double, mkl_blas_, xddot,
                       (const DAAL_INT * n, const double * x, const DAAL_INT * incx, const double * y, const DAAL_INT * incy), (n, x, incx, y, incy));
CALL_RET_FUNC_FROM_DLL(float, mkl_blas_, xsdot, (const DAAL_INT * n, const float * x, const DAAL_INT * incx, const float * y, const DAAL_INT * incy),
                       (n, x, incx, y, incy));
...
CALL_VOID_FUNC_FROM_DLL(mkl_spblas_, mkl_scsrmm, (CSRMM_ARGS(float)),
                        (transa, m, n, k, alpha, matdescra, val, indx, pntrb, pntre, b, ldb, beta, c, ldc));
CALL_VOID_FUNC_FROM_DLL(mkl_spblas_, mkl_dcsrmm, (CSRMM_ARGS(double)),
                        (transa, m, n, k, alpha, matdescra, val, indx, pntrb, pntre, b, ldb, beta, c, ldc));
...
CALL_RET_FUNC_FROM_DLL(IppStatus, mkl_dft_, ippsSortRadixAscend_64f_I, (Ipp64f * pSrcDst, Ipp64f * pTmp, Ipp32s len), (pSrcDst, pTmp, len));
CALL_RET_FUNC_FROM_DLL(IppStatus, mkl_dft_, ippsSortRadixAscend_32f_I, (Ipp32f * pSrcDst, Ipp32f * pTmp, Ipp32s len), (pSrcDst, pTmp, len));
...
CALL_VOID_FUNC_FROM_DLL_ALONE(mkl_serv_, set_num_threads, (int nth), (nth));
CALL_RET_FUNC_FROM_DLL_ALONE(int, mkl_serv_, get_max_threads, (void), ());
CALL_RET_FUNC_FROM_DLL_ALONE(int, mkl_serv_, set_num_threads_local, (int nth), (nth));
CALL_RET_FUNC_FROM_DLL_ALONE(int, mkl_serv_, get_ncpus, (void), ());
CALL_RET_FUNC_FROM_DLL_ALONE(int, mkl_serv_, get_ncorespercpu, (void), ());
CALL_RET_FUNC_FROM_DLL_ALONE(int, mkl_serv_, get_ht, (void), ());
CALL_RET_FUNC_FROM_DLL_ALONE(int, mkl_serv_, get_nlogicalcores, (void), ());
CALL_RET_FUNC_FROM_DLL_ALONE(int, mkl_serv_, cpuisknm, (void), ());
CALL_RET_FUNC_FROM_DLL_ALONE(int, mkl_serv_, enable_instructions, (int nth), (nth));
CALL_RET_FUNC_FROM_DLL_ALONE(int, mkl_serv_, memmove_s, (void * dest, size_t dmax, const void * src, size_t smax), (dest, dmax, src, smax));

typedef void (*func_type)(DAAL_INT, DAAL_INT, DAAL_INT, void *);

CALL_VOID_FUNC_FROM_DLL_ALONE(mkl_vsl_serv_, threader_for, (DAAL_INT n, DAAL_INT threads_request, void * a, func_type func),
                              (n, threads_request, a, func));
CALL_VOID_FUNC_FROM_DLL_ALONE(mkl_vsl_serv_, threader_for_ordered, (DAAL_INT n, DAAL_INT threads_request, void * a, func_type func),
                              (n, threads_request, a, func));
CALL_VOID_FUNC_FROM_DLL_ALONE(mkl_vsl_serv_, threader_sections, (DAAL_INT threads_request, void * a, func_type func), (threads_request, a, func));
CALL_VOID_FUNC_FROM_DLL_ALONE(mkl_vsl_serv_, threader_ordered, (DAAL_INT i, DAAL_INT th_idx, DAAL_INT th_num, void * a, func_type func),
                              (i, th_idx, th_num, a, func));
CALL_RET_FUNC_FROM_DLL_ALONE(DAAL_INT, mkl_vsl_serv_, threader_get_num_threads_limit, (void), ());
