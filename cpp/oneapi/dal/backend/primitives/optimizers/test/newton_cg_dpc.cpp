...
public:
    ...
    void gen_and_test_logistic_loss(std::int64_t n = -1,
        ...
        rn_gen.uniform_cpu(n_ * p_,
                           X_host.get_mutable_data(),
                           eng.get_cpu_engine_state(),
                           -10.0,
                           10.0);
        rn_gen.uniform_cpu(p_ + 1,
                           params_host.get_mutable_data(),
                           eng.get_cpu_engine_state(),
                           -5.0,
                           5.0);
    ...
    void gen_and_test_quadratic_function(std::int64_t n = -1) {
        ...
        rn_gen.uniform_cpu(n_, solution_.get_mutable_data(), eng.get_cpu_engine_state(), -1.0, 1.0);
